    ...
    var app = {
        ...
        newStroke: function () {
            ...
            if (xRange < range && xRange > -range && yRange < range && yRange > -range) {
                this.data.points.push([this.brush.startPosition.x, this.brush.startPosition.y, 0]);
            } else {
        ...
        drawPoint: function (x, y, rotation) {
        ...
        draw: function () {
            ...
            for (i = 0; i < pointsLen; i += 1) {
                ...
                this.drawPoint(item[0], item[1], item[2]);
                item[2] += 5 * (Math.PI / 180);
            }
